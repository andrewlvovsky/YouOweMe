...
class BorrowerViewController: UIViewController {
  ...
  var editMode: Bool
  var borrowerToEdit: BorrowerEntity?
...
extension BorrowerViewController: UITextFieldDelegate {
